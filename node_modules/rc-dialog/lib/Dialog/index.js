...
function Dialog(props) {
  ...
  if (maskClosable) {
    onWrapperClick = function onWrapperClick(e) {
      if (!(0, _contains.default)(contentRef.current.getDOM(), e.target)) {
        onInternalClose(e);
      }
    };
  }
  ...
  }, React.createElement(_Mask.default, {
    prefixCls: prefixCls,
  ...
  }, wrapProps), React.createElement(_Content.default, Object.assign({}, props, {
    ref: contentRef,
    closable: closable,
